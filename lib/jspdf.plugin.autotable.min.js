    ...
    var e = {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            (e.default = function (t, e, n, o, r) {
              ...
              if (
                ...
                "middle" === o.valign
                  ? (n -= (u / 2) * a * i)
                  : "bottom" === o.valign && (n -= u * a * i),
                "center" === o.halign || "right" === o.halign)
              ) {
                var d = a;
                if (("center" === o.halign && (d *= 0.5), s && u >= 1)) {
                  for (var h = 0; h < s.length; h++)
                    r.text(s[h], e - r.getStringUnitWidth(s[h]) * d, n),
                      (n += a * i);
                  return r;
                }
        ...
        200: function (t, e) {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (e.addTableBorder = function (t, e, o, r) {
              ...
              var a = n(i, !1);
              a &&
                t.rect(o.x, o.y, e.getWidth(t.pageSize().width), r.y - o.y, a);
            }),
            (e.getFillStyle = n),
        ...
        259: function (t, e, n) {
          ...
          e.parseCss = function (t, e, n, i, l) {
            ...
            -1 !== p.indexOf(i.textAlign) && (a.halign = i.textAlign),
              -1 !==
                (p = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) &&
                ...
                (t.prototype.applyStyles = function (e, n) {
                  ...
                  if ((e.font && (s = e.font), e.fontStyle)) {
                    ...
                    u &&
                      -1 === u.indexOf(a) &&
                      (this.jsPDFDocument.setFontStyle &&
                        this.jsPDFDocument.setFontStyle(u[0]),
                      (a = u[0]));
                  }
                  if (
                    (this.jsPDFDocument.setFont(s, a),
                    e.fontSize && this.jsPDFDocument.setFontSize(e.fontSize),
                    !n)
                  ) {
                    var d = t.unifyColor(e.fillColor);
                    d && (o = this.jsPDFDocument).setFillColor.apply(o, d),
                      (d = t.unifyColor(e.textColor)) &&
                        (r = this.jsPDFDocument).setTextColor.apply(r, d),
                      (d = t.unifyColor(e.lineColor)) &&
                        (i = this.jsPDFDocument).setDrawColor.apply(i, d),
        ...
        148: function (t, e, n) {
          ...
          function i(t, e, n, i, a, s) {
            for (
              var u = new r.HtmlRowInput(i), d = 0;
              d < i.cells.length;
              d++
            ) {
              var h = i.cells[d],
            ...
            var f = (function (t, e, n) {
              ...
              g = (function (t, e) {
                ...
                var m = null !== (l = e.useCss) && void 0 !== l && l,
                  ...
                  S =
                    null !== (a = e.horizontalPageBreakRepeat) && void 0 !== a
                      ? a
                      : null;
                return {
                  includeHiddenHtml:
                    null !== (s = e.includeHiddenHtml) && void 0 !== s && s,
                  useCss: m,
                  theme: b,
                  startY: v,
                  margin: y,
                  pageBreak:
                    null !== (u = e.pageBreak) && void 0 !== u ? u : "auto",
                  rowPageBreak:
                    null !== (d = e.rowPageBreak) && void 0 !== d ? d : "auto",
                  tableWidth:
                    null !== (h = e.tableWidth) && void 0 !== h ? h : "auto",
                  showHead: g,
                  showFoot: p,
                  tableLineWidth:
                    null !== (c = e.tableLineWidth) && void 0 !== c ? c : 0,
                  tableLineColor:
                    null !== (f = e.tableLineColor) && void 0 !== f ? f : 200,
              ...
              return (
                ...
                (t.prototype.callCellHooks = function (t, e, n, o, i, l) {
                  for (var a = 0, s = e; a < s.length; a++) {
                    ...
                    if (
                      ((n.text = Array.isArray(n.text) ? n.text : [n.text]), u)
                    )
                      return !1;
                  }
                  return !0;
                ...
                (t.prototype.callEndPageHooks = function (t, e) {
                  t.applyStyles(t.userStyles);
                  for (
                    var n = 0, o = this.hooks.didDrawPage;
                    n < o.length;
                    n++
                  ) {
            ...
            return (
              ...
              (t.prototype.getMinimumRowHeight = function (t, e) {
                ...
                return t.reduce(function (t, r) {
                  ...
                  if (!i) return 0;
                  var l =
                      (i.styles.fontSize / e.scaleFactor()) * o.FONT_ROW_RATIO,
        ...
        858: function (t, e, n) {
          ...
          function d(t, e, n, o, r, i, s) {
            ...
            var h = (0, a.assign)({}, d.table, d[t], r.styles, u),
              ...
              p =
                "body" === t && n % 2 == 0
                  ? (0, a.assign)({}, d.alternateRow, r.alternateRowStyles)
                  : {},
        ...
        49: function (t, e, n) {
          ...
          function h(t, e, n, o, r, l, s) {
            ...
            if (n.canEntireRowFit(u, s)) c(t, e, n, l, s);
              ...
              (function (t, e, n, o) {
                ...
                return e.getMaxCellHeight(o.columns) > l
                  ? (u &&
                      console.error(
                    ...
                    !0)
                  : !u && "avoid" !== o.settings.rowPageBreak;
              })(t, n, u, e)
            ) {
                ...
                for (var l = 0, s = 0, u = n.columns; s < u.length; s++) {
                  ...
                  if ((m = t.cells[h.index])) {
                    ...
                    (m.contentHeight = m.getContentHeight(p)),
                      m.contentHeight >= e &&
                        ((m.contentHeight = e), (c.styles.minCellHeight -= e)),
          ...
          function f(t, e, n) {
            var o = e.styles;
            if (
              (t.getDocument().setFillColor(t.getDocument().getFillColor()),
              "number" == typeof o.lineWidth)
            ) {
              ...
              l.map(function (i) {
                ...
                !(function (t, e, n, o, r, i) {
                  ...
                  t.getDocument().setLineWidth(i),
                    t.getDocument().line(l, a, s, u, r);
                })(t, e, n, i, l || "S", a[i]);
              });
            }
          }
          ...
          (e.drawTable = function (t, e) {
            var n = e.settings,
              ...
              f = o + i.bottom + d;
            "avoid" === n.pageBreak &&
              (f += e.allRows().reduce(function (t, e) {
                return t + e.height;
              }, 0));
            var y = new l.DocHandler(t);
            ("always" === n.pageBreak ||
              (null != n.startY && f > y.pageSize().height)) &&
              (g(y), (s.y = i.top));
            var v = (0, a.assign)({}, s);
            (e.startPageNumber = y.pageNumber()),
              !0 === n.horizontalPageBreak
                ? (function (t, e, n, o) {
                    u.default
                      .calculateAllColumnsCanFitInPage(t, e)
                      .map(function (r, i) {
                        t.applyStyles(t.userStyles),
                          i > 0
                            ? p(t, e, n, o, r.columns)
              ...
              (0, r.addTableBorder)(y, e, v, s),
              e.callEndPageHooks(y, s),
              (e.finalY = s.y),
              (t.lastAutoTable = e),
        ...
        435: function (t, e, n) {
          ...
          var o = n(200),
            ...
            i = function (t, e, n) {
              ...
              for (
                null != i &&
                (l = e.columns.find(function (t) {
                  return t.dataKey === i || t.index === i;
                })) &&
                (a.push(l.index),
                s.push(e.columns[l.index]),
                (o -= l.wrappedWidth));
                d < u;
                ...
                if ((null == l ? void 0 : l.index) !== d) {
                  ...
                  if (o < h) {
                    (0 !== d && d !== n.start) ||
                      (a.push(d), s.push(e.columns[d]));
                    break;
                  }
                  a.push(d), s.push(e.columns[d]), (o -= h), d++;
                } else d++;
              return { colIndexes: a, columns: s, lastIndex: d };
            };
          e.default = {
            getColumnsCanFitInPage: i,
            calculateAllColumnsCanFitInPage: function (t, e) {
              for (var n = [], o = 0, r = e.columns.length; o < r; ) {
                var l = i(t, e, { start: 0 === o ? 0 : o });
                l && l.columns && l.columns.length
                  ? ((o = l.lastIndex), n.push(l))
                  : o++;
              }
              return n;
            },
          ...
          function l(t, e, n, r, i) {
            return t.map(function (t) {
              return (function (t, e, n, r, i) {
                ...
                if (
                  (e = Math.ceil(e * l) / l) >= (0, o.getStringWidth)(t, n, r)
                )
                  return t;
                for (
                  ;
                  e < (0, o.getStringWidth)(t + i, n, r) && !(t.length <= 1);
              ...
              e.allRows().forEach(function (r) {
                for (var a = 0, s = e.columns; a < s.length; a++) {
                  ...
                  if (d) {
                    ...
                    d.contentWidth =
                      (0, o.getStringWidth)(d.text, d.styles, t) + c;
                    var f = (0, o.getStringWidth)(
                      d.text.join(" ").split(/\s+/),
                      d.styles,
                      t
                    );
                    if (
                      ((d.minReadableWidth = f + d.padding("horizontal")),
                      "number" == typeof d.styles.cellWidth)
                    )
                      (d.minWidth = d.styles.cellWidth),
                        (d.wrappedWidth = d.styles.cellWidth);
                    else if ("wrap" === d.styles.cellWidth || !0 === i)
                      d.contentWidth > l
                        ? ((d.minWidth = l), (d.wrappedWidth = l))
                        : ((d.minWidth = d.contentWidth),
                          (d.wrappedWidth = d.contentWidth));
                    else {
                      var p = 10 / n;
                      (d.minWidth = d.styles.minCellWidth || p),
                        (d.wrappedWidth = d.contentWidth),
                ...
                e.allRows().forEach(function (t) {
                  for (var n = 0, o = e.columns; n < o.length; n++) {
                    ...
                    if (i && 1 === i.colSpan)
                      ...
                      a &&
                        "number" == typeof a &&
                        ((r.minWidth = a), (r.wrappedWidth = a));
                    }
                    i &&
                      (i.colSpan > 1 &&
                        !r.minWidth &&
                        (r.minWidth = i.minWidth),
                      i.colSpan > 1 &&
                        !r.wrappedWidth &&
